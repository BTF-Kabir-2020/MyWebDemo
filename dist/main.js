...
async function windowLoadHandler() {
    ...
    document.body.addEventListener("mousemove", event => {
        ...
        document.body.insertAdjacentHTML("beforebegin", `<span class="fallowe" style="left:${event.pageX}px;top:${event.pageY}px"></span>`);

        for (let item of document.getElementsByClassName("fallowe")) {
